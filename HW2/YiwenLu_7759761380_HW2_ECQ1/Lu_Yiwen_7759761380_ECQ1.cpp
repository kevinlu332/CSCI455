...
#include <cmath>
#include <fstream>
#include "Lu_Yiwen_7759761380_ECQ1.h"
using namespace std;
// IDE: code::block
...
int main()
{
    array2D *a = new array2D(500,500); //create a 640x480 table
    int xRes, yRes;
    a->getSize(xRes,yRes);
    ...
    PGMImage *image = new PGMImage(xRes,yRes,"sub_fractal.pgm");
    image->getResolution(xRes,yRes);
    ///////create a blank image (done)////////////

    double cxmin = 0.270, cymin = 0.004, cxmax = 0.271, cymax = 0.005;// range of the small area
